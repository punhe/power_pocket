...
<%@ page import="com.se4f7.SWP.entities.Graph" %>
...
<head>
    ...
    <%
        List<Graph> dailyAmounts = (List<Graph>) request.getAttribute("dailyAmounts");
    %>
</head>
</head>
<%
...
<h1>Daily Amount by Status (Bar Chart)</h1>
