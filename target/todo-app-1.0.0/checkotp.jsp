            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form action="./check-otp" id="form-otp" >
                            <div class="d-flex align-items-center mb-3 pb-1">
                                <i class="fas fa-cubes fa-2x me-3" style="color: #ff6219;"></i>
                                <span class="h1 fw-bold mb-0">Verify OTP</span>
                            </div>

                            <h6 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px; color: blue; text-align: left;">${msg}</h6>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input class="form-control form-control-lg"
                                       placeholder="Enter OTP" id="otp" name="otp" rules="required|number"/>
